...
export const SEED_ITEMS: {
  ...
  },
  {
    ...
    title: "英语·新概念一册（空腹在家）",
    detail: "主线：新概念英语第一册（补你最缺的语法地基）。摸底 A2：基础词/拼写/简单句都没问题，缺的是语法系统——前约20课偏简单可加速跟读，语法变新（时态等）后回正常速度。15min复习昨课跟读 + 35min学新课（盲听→读懂全文→记语法点）+ 30min影子跟读课文（练听说）+ 20min单词（本课生词+基础2000词，暂不碰四级词汇）。查莉中字磨耳朵不强求",
  },
  // ---------- 周末上午 ----------
  {
    track: "ai",
